    ...
    <dd>
      <ul>
        ...
        <li>      
          ...
          <p>In what follows, we run the Dijkstra code and the A* code in the same environment and plot out the following animation:</p>
...
<img src="https://github.com/Thorkee/ENG1003_w1_Group3/blob/main/Image%20Resources/DJ%20vs%20A%20STAR.gif" alt="demo of dij alg">  
  ...
  <p>We can find that in a complex environment, the Dijkstra code is so computationally large on long-range search that it makes the computation even slower because it does not combine the location of endpoints when performing breadth search.</p></p>

<p>However, this code is not without its advantages. Since it performs a more comprehensive search of the map, the computed route is closer to the "shortest distance" goal and achieves a more desirable goal.</p>
        </li>
        <li>
